...
do 
 ...
 #  python word2vec_optimized.py --use --train_data=data/2016-12-07-text8-synsets.txt --eval_data=data/$sf --answer_filename=$af --save_path=models/synsets  &>> gold-data/$outputFile
   echo "Lenient=True" >> gold-data/$outputFile
   python word2vec_optimized.py --use --train_data=data/2016-12-07-text8-synsets.txt --eval_data=data/$sf --answer_filename=$af --save_path=models/synsets --lenient &>> gold-data/$outputFile
done
